...
const MARKETJECT_MAP_LAYERS: MapLayers = {
  gpsJamming: false,
  satellites: false,
...
const MARKETJECT_MOBILE_MAP_LAYERS: MapLayers = {
  gpsJamming: false,
  satellites: false,
