...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  marketject: {
    title: 'MarketJect - CEO Intelligence Dashboard',
    description: 'Real-time executive intelligence dashboard blending market data, tech industry, cybersecurity, and geopolitical risk for strategic decision-making.',
    keywords: 'CEO dashboard, executive intelligence, market data, tech industry, cybersecurity, geopolitical risk, macro signals, AI insights, strategic intelligence, business strategy, competitive intelligence',
    url: 'https://marketject.worldmonitor.app/',
    siteName: 'MarketJect',
    shortName: 'MarketJect',
    subject: 'Executive Market, Tech & Geopolitical Intelligence',
    classification: 'Executive Dashboard, Market Intelligence, Strategic Risk',
